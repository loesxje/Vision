...
"BPN format: "
print
"\t BPN Inputlayer  = " + str(ITset.shape[1]) + " neurons"
print
"\t BPN Outputlayer = " + str(OTset.shape[1]) + " neurons"
...
while ((sumSqrDiffError > MAX_OUTPUT_ERROR) & (runs < MAXRUNS)):
    ...
    for inputSetRowNr in range(ITset.shape[0]):
        ...
        W0 = W1
    print
    "sumSqrDiffError = " + str(sumSqrDiffError)
    runs += 1
